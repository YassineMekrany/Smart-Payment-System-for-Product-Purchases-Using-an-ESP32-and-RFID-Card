<?php
    // Clear the UIDContainer.php file when this page is loaded
...
<head>
    ...
    <script>
        $(document).ready(function(){
            // Load UIDContainer.php and set the textarea value
            function loadUID() {
                $("#getUID").load("UIDContainer.php", function(response, status, xhr) {
                    if (status == "error") {
            ...
            loadUID(); // Initial load
            setInterval(loadUID, 500); // Update every 500ms
        });
    </script>
        ...
        <div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
            ...
            <form class="form-horizontal" action="insertDB.php" method="post" >
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="solde" type="text" placeholder="Enter your balance" required>
                    </div>
                </div>
